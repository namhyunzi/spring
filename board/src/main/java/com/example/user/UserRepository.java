 ...
 * 		Spring JPA의 JpaRepository<T, ID> 인터페이스를 상속받아서 작성한다.
 ...
 * 		JpaRepository 인터페이스 및 그 상위 인터페이스에 정의된 모든 추상화된 메소드들이 재정의 된(구현된) 구현객체를
 ...
 * 	2. JpaRepository인터페이스의 타입파라미터 타입을 설정한다.
